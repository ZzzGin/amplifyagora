...
class MarketPage extends React.Component {
  ...
  componentDidMount() {
    ...
    this.hanldleGetMarket();
    this.createProductListener = API.graphql(graphqlOperation(onCreateProduct, {owner: user.username})).subscribe({
      next: productData => {
    ...
    this.updateProductListener = API.graphql(graphqlOperation(onUpdateProduct, {owner: user.username})).subscribe({
      next: productData => {
    ...
    this.deleteProductListener = API.graphql(graphqlOperation(onDeleteProduct, {owner: user.username})).subscribe({
      next: productData => {
